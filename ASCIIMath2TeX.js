...
to TeX.  Two functions:
	AMTparseMath(string): takes ASCIIMath string, and returns an IMG node
		set up for rendering the string
	AMTparseAMtoTeX(string): takes ASCIIMath string, and returns a TeX
		string

Based on ASCIIMathML, Version 1.4.7 Aug 30, 2005, (c) Peter Jipsen http://www.chapman.edu/~jipsen

Modified with TeX conversion Sept 6, 2006 (c) David Lippman http://www.pierce.ctc.edu/dlippman
